...
_BASE_RAMPS = {
    ...
    # user-approved (Aug 24). Night authored. Lime/Orange/Green given real
    # ramps at 69px (v5). Scoopy pass (Aug 26): Gold/Diamond/Night/Lime/
    # Orange base retuned, Toad + Sick added.
    "Classic":  {2: (0x62, 0xC8, 0x75), 3: (0x8B, 0xD0, 0x7C),
                 4: (0x2D, 0x50, 0x34), 10: (0x24, 0x42, 0x29)},
    "Gold":     {2: (0xCA, 0xD4, 0x35), 3: (0xF0, 0xDA, 0x7B),
                 4: (0xA8, 0x84, 0x2B), 10: (0x6B, 0x50, 0x2A),
                 19: (0xAB, 0x8B, 0x2C)},   # hand-set (studio pass)
    "Zombie":   {2: (0xB9, 0xC4, 0xB0), 3: (0xD6, 0xDE, 0xD0),
                 4: (0x6E, 0x7A, 0x66), 10: (0x4A, 0x3E, 0x36)},
    "Diamond":  {2: (0x5F, 0xE3, 0xB0), 3: (0xA9, 0xF4, 0xE8),
                 4: (0x35, 0xB5, 0xA4), 10: (0x2E, 0x6E, 0x74),
                 19: (0x43, 0xB8, 0xA7)},   # hand-set (studio pass)
    "Night":    {2: (0x3C, 0x67, 0x6D), 3: (0x5A, 0x6F, 0x94),
                 4: (0x25, 0x31, 0x4A), 10: (0x2E, 0x2A, 0x3A),
                 19: (0x2B, 0x38, 0x51)},   # hand-set (studio pass)
    "Lime":     {2: (0xCD, 0xF8, 0xAA), 3: (0xD9, 0xD9, 0xD9),
                 4: (0x6E, 0x6E, 0x6E), 10: (0x4E, 0x4E, 0x4E),
                 19: (0x81, 0x81, 0x81)},   # hand-set (studio pass)
    "Orange":   {2: (0xDA, 0x88, 0x16), 3: (0xFF, 0xBE, 0x5C),
                 4: (0xB3, 0x64, 0x00), 10: (0x7A, 0x44, 0x00),
                 19: (0xC3, 0x70, 0x00)},   # hand-set (studio pass)
    "Green":    {2: (0x13, 0x70, 0x00), 3: (0x46, 0xA0, 0x2E),
                 4: (0x0C, 0x4A, 0x00), 10: (0x08, 0x34, 0x00)},
    "Toad":     {2: (0x9C, 0xB3, 0x5B), 3: (0x46, 0xA0, 0x2E),
                 4: (0x0C, 0x4A, 0x00), 10: (0x08, 0x34, 0x00),
                 19: (0x0E, 0x54, 0x00)},   # hand-set (studio pass)
    "Sick":     {2: (0x99, 0xA2, 0x10), 3: (0x46, 0xA0, 0x2E),
                 4: (0x0C, 0x4A, 0x00), 10: (0x08, 0x34, 0x00),
                 19: (0x0E, 0x54, 0x00)},   # hand-set (studio pass)
}
...
def _extend(ramp):
    ...
    # slots already present in the ramp dict are HAND-SET and win over the
    # derivation (scoopy's Aug 26 studio pass pinned some 19s by eye).
    out = dict(ramp)
    out.setdefault(16, _lighten(ramp[3], 0.32))
    out.setdefault(17, _darken(ramp[4], 0.42))
    out.setdefault(18, _lighten(ramp[3], 0.62))
    out.setdefault(19, _darken(_mix(ramp[2], ramp[4], 0.5), 0.10))
    return out
...
IRISES = [
    ...
    ("Onyx",    (0x14, 0x14, 0x16)),
    ("BASE",    (0x11, 0x00, 0xFF)),
    ("Magenta", (0xFF, 0x00, 0xC8)),
    ("NeonGreen", (0x11, 0xFF, 0x00)),
    ("Grey",    (0xB9, 0xDB, 0xDF)),
]
