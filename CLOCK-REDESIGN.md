...
rebirth is reserveSpawn plus three confirmed, resumable birthStep calls.
Redemption remains remaining-R/S pro rata with floor rounding, not a separately
stored immutable exchange-rate scalar. Reinvestment requires owner/operator intent.
