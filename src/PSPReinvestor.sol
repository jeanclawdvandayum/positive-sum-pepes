...
contract PSPReinvestor is ReentrancyGuard {
    ...
    function reinvest(uint256 pepeId, PoolKey calldata key, uint256 minPspOut, uint256 deadline) external nonReentrant {
        ...
        // owner (or an authorized operator) controls the transaction.
