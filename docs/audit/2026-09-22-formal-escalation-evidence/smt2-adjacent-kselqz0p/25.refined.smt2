...
(assert
 ...
 (= ?x54 (_ bv0 256)))))
(assert
 (not (= (f_evm_bvudiv_256 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00) (_ bv10000 256)) (_ bv0 256))))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00)))
 (let ((?x52 (f_evm_bvudiv_256 ?x50 (_ bv10000 256))))
 (bvule (bvadd (_ bv1 256) (f_evm_bvudiv_256 p_pot_uint256_bc9865a_00 (_ bv10000 256))) ?x52))))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00)))
 (let ((?x52 (f_evm_bvudiv_256 ?x50 (_ bv10000 256))))
 (let ((?x34 (f_evm_bvudiv_256 p_pot_uint256_bc9865a_00 (_ bv10000 256))))
