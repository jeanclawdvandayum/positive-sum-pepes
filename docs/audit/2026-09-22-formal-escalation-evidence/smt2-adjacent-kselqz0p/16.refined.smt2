...
(assert
 ...
 (and $x39 $x42))))
(assert
 (let ((?x36 (f_evm_bvurem_256 p_pot_uint256_bc9865a_00 (_ bv10000 256))))
 (= ?x36 (_ bv0 256))))
(assert
 (not (= (f_evm_bvudiv_256 p_pot_uint256_bc9865a_00 (_ bv10000 256)) (_ bv0 256))))
(assert
 (let ((?x49 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00)))
 (bvule p_pot_uint256_bc9865a_00 ?x49)))
(assert
 (let ((?x49 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00)))
 (let ((?x51 (f_evm_bvudiv_256 ?x49 (_ bv10000 256))))
 (bvule ?x51 ?x49))))
(assert
 (let (($x57 (bvule ((_ extract 13 0) (f_evm_bvurem_256 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00) (_ bv10000 256))) (_ bv10000 14))))
 (let (($x55 (= ((_ extract 255 14) (f_evm_bvurem_256 (bvadd (_ bv1 256) p_pot_uint256_bc9865a_00) (_ bv10000 256))) (_ bv0 242))))
 (and $x55 $x57))))
(assert
