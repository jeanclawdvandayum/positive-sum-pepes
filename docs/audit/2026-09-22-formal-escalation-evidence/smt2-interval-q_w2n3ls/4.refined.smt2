...
(assert
 (let ((?x61 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (bvmul (_ bv10000 256) (f_evm_bvudiv_256 p_pot_uint256_e39ccfa_00 (_ bv10000 256))))))
 (not (bvule p_pot_uint256_e39ccfa_00 ?x61))))
(assert
 (let ((?x70 (bvadd (_ bv10000 256) p_pot_uint256_e39ccfa_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_e39ccfa_00 (_ bv10000 256))))))
 (bvule ?x70 p_pot_uint256_e39ccfa_00)))
(assert
 (let ((?x78 (bvadd (_ bv10000 14) ((_ extract 13 0) p_pot_uint256_e39ccfa_00) (bvmul (_ bv6384 14) ((_ extract 13 0) (f_evm_bvudiv_256 p_pot_uint256_e39ccfa_00 (_ bv10000 256)))))))
 (let ((?x70 (bvadd (_ bv10000 256) p_pot_uint256_e39ccfa_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_e39ccfa_00 (_ bv10000 256))))))
