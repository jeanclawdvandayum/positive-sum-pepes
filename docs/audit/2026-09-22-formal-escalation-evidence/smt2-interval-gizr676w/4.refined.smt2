...
(assert
 ...
 (and $x36 $x39))))
(assert
 (let ((?x33 (f_evm_bvurem_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))
 (= ?x33 (_ bv0 256))))
(assert
 (not (= (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256)) (_ bv0 256))))
(assert
 (let ((?x31 (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))
 (bvule (_ bv1 256) ?x31)))
(assert
 (let (($x52 (bvule ((_ extract 242 0) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))) (_ bv11579208923731619542357098500868790785326998466564056403945758400791312964 243))))
 (let (($x49 (= ((_ extract 255 243) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))) (_ bv0 13))))
 (and $x49 $x52))))
(assert
...
(assert
 ...
 (bvule ?x57 ?x31))))
(assert
 (let ((?x61 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (bvmul (_ bv10000 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
 (let ((?x31 (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))
 (let ((?x57 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) ?x31)))
...
(assert
 (let ((?x61 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (bvmul (_ bv10000 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
 (not (bvule p_pot_uint256_2b74c53_00 ?x61))))
(assert
 (let ((?x70 (bvadd (_ bv10000 256) p_pot_uint256_2b74c53_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
 (bvule ?x70 p_pot_uint256_2b74c53_00)))
(assert
 (let ((?x78 (bvadd (_ bv10000 14) ((_ extract 13 0) p_pot_uint256_2b74c53_00) (bvmul (_ bv6384 14) ((_ extract 13 0) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256)))))))
 (let ((?x70 (bvadd (_ bv10000 256) p_pot_uint256_2b74c53_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
