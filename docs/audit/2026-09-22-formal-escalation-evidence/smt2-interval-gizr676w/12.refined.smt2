...
(assert
 (let ((?x31 (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))
 (let ((?x63 (bvmul (_ bv10000 256) ?x31)))
 (not (bvule p_pot_uint256_2b74c53_00 ?x63)))))
(assert
 (let ((?x73 (bvadd p_pot_uint256_2b74c53_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
 (bvule ?x73 p_pot_uint256_2b74c53_00)))
(assert
 (let ((?x81 (bvadd ((_ extract 13 0) p_pot_uint256_2b74c53_00) (bvmul (_ bv6384 14) ((_ extract 13 0) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256)))))))
 (let ((?x73 (bvadd p_pot_uint256_2b74c53_00 (bvmul (_ bv115792089237316195423570985008687907853269984665640564039457584007913129629936 256) (f_evm_bvudiv_256 p_pot_uint256_2b74c53_00 (_ bv10000 256))))))
