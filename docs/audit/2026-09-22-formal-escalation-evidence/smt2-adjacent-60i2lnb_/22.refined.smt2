...
(assert
 ...
 (and $x39 $x42))))
(assert
 (not (= (f_evm_bvurem_256 p_pot_uint256_efa6d9c_00 (_ bv10000 256)) (_ bv0 256))))
(assert
 (not (= (f_evm_bvudiv_256 p_pot_uint256_efa6d9c_00 (_ bv10000 256)) (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256))))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00)))
 (bvule p_pot_uint256_efa6d9c_00 ?x50)))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00)))
 (let ((?x52 (f_evm_bvudiv_256 ?x50 (_ bv10000 256))))
 (bvule ?x52 ?x50))))
(assert
 (let (($x58 (bvule ((_ extract 13 0) (f_evm_bvurem_256 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00) (_ bv10000 256))) (_ bv10000 14))))
 (let (($x56 (= ((_ extract 255 14) (f_evm_bvurem_256 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00) (_ bv10000 256))) (_ bv0 242))))
 (and $x56 $x58))))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00)))
 ...
 (= ?x54 (_ bv0 256)))))
(assert
 (not (= (f_evm_bvudiv_256 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00) (_ bv10000 256)) (_ bv0 256))))
(assert
 (let ((?x50 (bvadd (_ bv1 256) p_pot_uint256_efa6d9c_00)))
 (let ((?x52 (f_evm_bvudiv_256 ?x50 (_ bv10000 256))))
 (let ((?x34 (f_evm_bvudiv_256 p_pot_uint256_efa6d9c_00 (_ bv10000 256))))
 (let ((?x63 (bvadd (_ bv1 256) ?x34)))
 (bvule ?x63 ?x52))))))
(assert
 (let ((?x34 (f_evm_bvudiv_256 p_pot_uint256_efa6d9c_00 (_ bv10000 256))))
 (let ((?x66 (bvadd (_ bv2 256) ?x34)))
 (let ((?x63 (bvadd (_ bv1 256) ?x34)))
 (bvule ?x63 ?x66)))))
(assert
 (let ((?x34 (f_evm_bvudiv_256 p_pot_uint256_efa6d9c_00 (_ bv10000 256))))
