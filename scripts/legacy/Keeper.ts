// ARCHIVED: incompatible with current contracts. Never execute against this release.
throw new Error("Archived keeper: retired controller APIs; use the staking page.");
/**
